<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/FrontEnd.Master" CodeBehind="PatientGuide.aspx.vb" Inherits="SDMC.PatientGuide" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Patient Guide</h1></div>
                <div class="bread-crumb pull-right">
                <ul>
                <li><a href="index.html">Home</a></li>
                <li><a href="about-us.html">Patient Guide</a></li>
                </ul>
                </div>
            </div>
         </div>
         ...
         <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 dept-tabs-wrap wow fadeInUp animated animated" data-wow-delay="1s" data-wow-offset="200" style="visibility: visible;-webkit-animation-delay: 1s; -moz-animation-delay: 1s; animation-delay: 1s;">
                    
              <!-- tabs left -->
              <div class="tabbable tabs-left">
                <ul class="nav nav-tabs col-md-4 col-sm-4 col-xs-5">
                  <li class="active"><a href="#a" data-toggle="tab"><i class="icon-eye-open dept-tabs-icon"></i><span class="tabs-heads">Patient Guide</span><i class="right-arr"></i></a></li>
                  <li class=""><a href="#b" data-toggle="tab"><i class="icon-heart dept-tabs-icon"></i><span class="tabs-heads">Admission</span><i class="right-arr"></i></a></li>
                  <li class=""><a href="#c" data-toggle="tab"><i class="icon-food dept-tabs-icon"></i><span class="tabs-heads">Inpatient Rooms</span><i class="right-arr"></i></a></li>
                  <li class=""><a href="#d" data-toggle="tab"><i class="icon-ambulance dept-tabs-icon"></i><span class="tabs-heads">Guest Services</span><i class="right-arr"></i></a></li>
                  <li class=""><a href="#e" data-toggle="tab"><i class="icon-medkit dept-tabs-icon"></i><span class="tabs-heads">Service Enchancements</span><i class="right-arr"></i></a></li>
                  <li class=""><a href="#f" data-toggle="tab"><i class="icon-hospital dept-tabs-icon"></i><span class="tabs-heads">Other Amenities</span><i class="right-arr"></i></a></li>
                  <li class=""><a href="#g" data-toggle="tab"><i class="icon-eye-open dept-tabs-icon"></i><span class="tabs-heads">Food Options</span><i class="right-arr"></i></a></li>
                  <li><a href="#h" data-toggle="tab"><i class="icon-stethoscope dept-tabs-icon"></i><span class="tabs-heads">Health and Wellness Library</span><i class="right-arr"></i></a></li>
                ...
                <div class="sidebar-wrap-dept col-md-4 col-sm-4 col-xs-12 no-pad wow fadeInUp animated animated" data-wow-delay="1s" data-wow-offset="200" style="visibility: visible;-webkit-animation-delay: 1s; -moz-animation-delay: 1s; animation-delay: 1s;">
                ...
                <div class="dept-call-info wow fadeInUp animated idept-call animated" data-wow-delay="1s" data-wow-offset="200" style="visibility: visible;-webkit-animation-delay: 1s; -moz-animation-delay: 1s; animation-delay: 1s;">
